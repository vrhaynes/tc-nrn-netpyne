...
TITLE Channel: Syn_GABAA_DeepFS_L4SS

COMMENT
    Synapse with syn scaling constant c = 1.5 nS (translating to max cond of 1.5e-06 mS), time course: 6 ms and reversal potential: -75 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_DeepFS_L4SS 6 1.5 -75 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_DeepFS_L4SS
