...
TITLE Channel: Syn_AMPA_TCR_DeepBask

COMMENT
    Synapse with syn scaling constant c = 1.5 nS (translating to max cond of 5.51819e-07 mS), time course: 1 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_TCR_DeepBask 1 1.5 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_TCR_DeepBask
