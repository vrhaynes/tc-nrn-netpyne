...
TITLE Channel: Syn_AMPA_SupPyr_L5Pyr

COMMENT
    Synapse with syn scaling constant c = 0.1 nS (translating to max cond of 7.35759e-08 mS), time course: 2 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_SupPyr_L5Pyr 2 0.1 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_SupPyr_L5Pyr
