...
TITLE Channel: Syn_NMDA_L6NT_nRT

COMMENT
    Synapse with syn scaling constant c = 0.05 nS (translating to max cond of 5e-08 mS), time course: 150 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_NMDA_L6NT_nRT 150 0.05 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_NMDA_L6NT_nRT
