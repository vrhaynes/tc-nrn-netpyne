...
TITLE Channel: Syn_AMPA_SupPyr_DeepFS

COMMENT
    Synapse with syn scaling constant c = 1 nS (translating to max cond of 2.94304e-07 mS), time course: 0.8 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_SupPyr_DeepFS 0.8 1 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_SupPyr_DeepFS
...
PARAMETER {
    gmax = 0.00029430355293700005
    tau_rise = 0.8 (ms) <1e-9,1e9>
    tau_decay = 0.8 (ms) <1e-9,1e9>
    e = 0.0  (mV)
