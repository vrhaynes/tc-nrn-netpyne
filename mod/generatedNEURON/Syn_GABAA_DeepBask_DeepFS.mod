...
TITLE Channel: Syn_GABAA_DeepBask_DeepFS
...
COMMENT
    Synapse with syn scaling constant c = 0.2 nS (translating to max cond of 2e-07 mS), time course: 3 ms and reversal potential: -75 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_DeepBask_DeepFS 3 0.2 -75 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_DeepBask_DeepFS
