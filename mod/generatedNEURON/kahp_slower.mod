...
TITLE Channel: kahp_slower

COMMENT
    Slow [Ca2+] dependent K AHP (afterhyperpolarization) conductance. Slower version of kahp from Traub et al 2003
ENDCOMMENT
...
PROCEDURE settables(v(mV), cai(mM)) {  
    ...
    ? Found a generic form of the rate equation for alpha, using expression: ca_conc < 0.0005 ? ca_conc/0.05 : 0.01
