...
TITLE Channel: Syn_NMDA_L6NT_TCR

COMMENT
    Synapse with syn scaling constant c = 0.075 nS (translating to max cond of 7.5e-08 mS), time course: 130 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_NMDA_L6NT_TCR 130 0.075 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_NMDA_L6NT_TCR
