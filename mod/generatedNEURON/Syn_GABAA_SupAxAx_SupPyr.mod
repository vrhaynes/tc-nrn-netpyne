...
TITLE Channel: Syn_GABAA_SupAxAx_SupPyr
...
COMMENT
    Synapse with syn scaling constant c = 1.2 nS (translating to max cond of 1.2e-06 mS), time course: 6 ms and reversal potential: -81 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_SupAxAx_SupPyr 6 1.2 -81 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_SupAxAx_SupPyr
