...
TITLE Channel: Syn_GABAA_SupBask_L4SS

COMMENT
    Synapse with syn scaling constant c = 0.1 nS (translating to max cond of 1e-07 mS), time course: 6 ms and reversal potential: -75 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_SupBask_L4SS 6 0.1 -75 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_SupBask_L4SS
