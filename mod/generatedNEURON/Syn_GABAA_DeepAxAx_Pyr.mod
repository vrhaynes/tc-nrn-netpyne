...
TITLE Channel: Syn_GABAA_DeepAxAx_Pyr

COMMENT
    Synapse with syn scaling constant c = 1 nS (translating to max cond of 1e-06 mS), time course: 6 ms and reversal potential: -81 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_DeepAxAx_Pyr 6 1 -81 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_DeepAxAx_Pyr
