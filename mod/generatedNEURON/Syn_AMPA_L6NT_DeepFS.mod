...
TITLE Channel: Syn_AMPA_L6NT_DeepFS

COMMENT
    Synapse with syn scaling constant c = 3 nS (translating to max cond of 8.82911e-07 mS), time course: 0.8 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_L6NT_DeepFS 0.8 3 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_L6NT_DeepFS
