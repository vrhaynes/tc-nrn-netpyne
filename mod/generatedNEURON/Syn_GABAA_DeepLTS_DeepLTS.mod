...
TITLE Channel: Syn_GABAA_DeepLTS_DeepLTS

COMMENT
    Synapse with syn scaling constant c = 0.05 nS (translating to max cond of 5e-08 mS), time course: 20 ms and reversal potential: -75 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_DeepLTS_DeepLTS 20 0.05 -75 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_DeepLTS_DeepLTS
