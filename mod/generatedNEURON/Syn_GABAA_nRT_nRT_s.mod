...
TITLE Channel: Syn_GABAA_nRT_nRT_s

COMMENT
    Synapse with syn scaling constant c = 44.5 nS (translating to max cond of 4.45e-05 mS), time course: 9 ms and reversal potential: -75 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_nRT_nRT_s 9 44.5 -75 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_nRT_nRT_s
