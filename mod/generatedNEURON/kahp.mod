...
COMMENT
    [Ca2+] dependent K AHP (afterhyperpolarization) conductance. Based on NEURON port of FRB L2/3 model from Traub et al 2003. Same channel used in Traub et al 2005
ENDCOMMENT
...
PROCEDURE settables(v(mV), cai(mM)) {  
    ...
    ? Found a generic form of the rate equation for beta, using expression: 0.01
