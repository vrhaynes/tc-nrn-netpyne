...
TITLE Channel: Syn_GABAA_SupAxAx_DeepPyr

COMMENT
    Synapse with syn scaling constant c = 1 nS (translating to max cond of 1e-06 mS), time course: 6 ms and reversal potential: -75 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_SupAxAx_DeepPyr 6 1 -75 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_SupAxAx_DeepPyr
