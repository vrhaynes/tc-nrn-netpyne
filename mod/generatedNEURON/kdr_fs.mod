...
TITLE Channel: kdr_fs

COMMENT
    Potasium delayed rectifier type conductance for fast-spiking (FS) interneurons for RD Traub et al 2005
ENDCOMMENT
...
PROCEDURE rates(v(mV)) {  
 ...
 FROM -120 TO 60 WITH 741
    ...
    ? Found a generic form of the rate equation for tau, using expression: v <= -10 ? 0.25 + 4.35 * (exp (( v + 10 )/10)) : 0.25 + 4.35 * (exp ((- v - 10)/ 10))
