...
TITLE Channel: Syn_NMDA_SupPyr_SupPyr

COMMENT
    Synapse with syn scaling constant c = 0.025 nS (translating to max cond of 2.5e-08 mS), time course: 130 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_NMDA_SupPyr_SupPyr 130 0.025 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_NMDA_SupPyr_SupPyr
