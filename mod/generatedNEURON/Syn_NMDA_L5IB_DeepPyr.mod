...
TITLE Channel: Syn_NMDA_L5IB_DeepPyr

COMMENT
    Synapse with syn scaling constant c = 0.2 nS (translating to max cond of 2e-07 mS), time course: 130 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_NMDA_L5IB_DeepPyr 130 0.2 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_NMDA_L5IB_DeepPyr
