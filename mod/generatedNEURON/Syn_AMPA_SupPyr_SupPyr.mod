...
TITLE Channel: Syn_AMPA_SupPyr_SupPyr

COMMENT
    Synapse with syn scaling constant c = 0.25 nS (translating to max cond of 1.8394e-07 mS), time course: 2 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_SupPyr_SupPyr 2 0.25 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_SupPyr_SupPyr
