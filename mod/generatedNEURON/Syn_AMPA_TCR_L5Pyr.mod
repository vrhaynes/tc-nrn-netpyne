...
TITLE Channel: Syn_AMPA_TCR_L5Pyr

COMMENT
    Synapse with syn scaling constant c = 1.5 nS (translating to max cond of 1.10364e-06 mS), time course: 2 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_TCR_L5Pyr 2 1.5 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_TCR_L5Pyr
