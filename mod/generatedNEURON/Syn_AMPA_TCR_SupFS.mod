...
TITLE Channel: Syn_AMPA_TCR_SupFS

COMMENT
    Synapse with syn scaling constant c = 0.1 nS (translating to max cond of 3.67879e-08 mS), time course: 1 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_TCR_SupFS 1 0.1 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_TCR_SupFS
