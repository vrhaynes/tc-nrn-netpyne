...
TITLE Channel: Syn_GABAA_SupLTS_L5Pyr
...
COMMENT
    Synapse with syn scaling constant c = 0.02 nS (translating to max cond of 2e-08 mS), time course: 20 ms and reversal potential: -81 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_SupLTS_L5Pyr 20 0.02 -81 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_SupLTS_L5Pyr
