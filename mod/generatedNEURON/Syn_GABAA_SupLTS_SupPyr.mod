...
TITLE Channel: Syn_GABAA_SupLTS_SupPyr
...
COMMENT
    Synapse with syn scaling constant c = 0.01 nS (translating to max cond of 1e-08 mS), time course: 20 ms and reversal potential: -81 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_SupLTS_SupPyr 20 0.01 -81 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_SupLTS_SupPyr
