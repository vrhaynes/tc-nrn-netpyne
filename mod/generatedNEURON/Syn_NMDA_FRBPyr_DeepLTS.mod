...
TITLE Channel: Syn_NMDA_FRBPyr_DeepLTS

COMMENT
    Synapse with syn scaling constant c = 0.1 nS (translating to max cond of 1e-07 mS), time course: 100 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_NMDA_FRBPyr_DeepLTS 100 0.1 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_NMDA_FRBPyr_DeepLTS
