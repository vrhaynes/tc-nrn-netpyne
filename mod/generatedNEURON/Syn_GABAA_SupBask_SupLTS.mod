...
TITLE Channel: Syn_GABAA_SupBask_SupLTS

COMMENT
    Synapse with syn scaling constant c = 0.5 nS (translating to max cond of 5e-07 mS), time course: 3 ms and reversal potential: -75 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_SupBask_SupLTS 3 0.5 -75 
ENDCOMMENT
