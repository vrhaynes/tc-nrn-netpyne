...
COMMENT
    Potasium A-type conductance (transient, inactivating). Based on NEURON port of FRB L2/3 model from Traub et al 2003. Same channel used in Traub et al 2005
ENDCOMMENT
...
PROCEDURE rates(v(mV)) {  
 ...
 FROM -120 TO 60 WITH 741
    ...
    ? Found a generic form of the rate equation for tau, using expression: v < -63.0 ? 0.5 / ((exp (( v + 46 )/5)) + (exp (( -v - 238 )/37.5))) : 9.5
