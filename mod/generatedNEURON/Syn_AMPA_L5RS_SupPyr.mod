...
TITLE Channel: Syn_AMPA_L5RS_SupPyr

COMMENT
    Synapse with syn scaling constant c = 0.5 nS (translating to max cond of 3.67879e-07 mS), time course: 2 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_L5RS_SupPyr 2 0.5 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_L5RS_SupPyr
