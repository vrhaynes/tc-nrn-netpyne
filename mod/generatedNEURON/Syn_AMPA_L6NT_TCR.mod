...
TITLE Channel: Syn_AMPA_L6NT_TCR

COMMENT
    Synapse with syn scaling constant c = 0.75 nS (translating to max cond of 5.51819e-07 mS), time course: 2 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_L6NT_TCR 2 0.75 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_L6NT_TCR
