...
TITLE Channel: Syn_GABAA_DeepBask_L5Pyr

COMMENT
    Synapse with syn scaling constant c = 0.7 nS (translating to max cond of 7e-07 mS), time course: 6 ms and reversal potential: -81 mV.
        Automatically generated by command:  genSyn.py Syn_GABAA_DeepBask_L5Pyr 6 0.7 -81 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_GABAA_DeepBask_L5Pyr
