...
TITLE Channel: Syn_AMPA_SupPyr_DeepLTS

COMMENT
    Synapse with syn scaling constant c = 1 nS (translating to max cond of 3.67879e-07 mS), time course: 1 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_SupPyr_DeepLTS 1 1 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_SupPyr_DeepLTS
...
PARAMETER {
    gmax = 0.000367879441171
    tau_rise = 1 (ms) <1e-9,1e9>
    tau_decay = 1 (ms) <1e-9,1e9>
    e = 0.0  (mV)
