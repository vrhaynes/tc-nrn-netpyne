...
TITLE Channel: Syn_AMPA_SupPyr_SupLTS

COMMENT
    Synapse with syn scaling constant c = 2 nS (translating to max cond of 7.35759e-07 mS), time course: 1 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_AMPA_SupPyr_SupLTS 1 2 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_AMPA_SupPyr_SupLTS
