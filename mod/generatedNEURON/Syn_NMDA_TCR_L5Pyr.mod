...
TITLE Channel: Syn_NMDA_TCR_L5Pyr

COMMENT
    Synapse with syn scaling constant c = 0.15 nS (translating to max cond of 1.5e-07 mS), time course: 130 ms and reversal potential: 0 mV.
        Automatically generated by command:  genSyn.py Syn_NMDA_TCR_L5Pyr 130 0.15 0 
ENDCOMMENT
...
NEURON {
    POINT_PROCESS Syn_NMDA_TCR_L5Pyr
