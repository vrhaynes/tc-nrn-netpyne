...
PROCEDURE rates(v(mV)) {  
 ...
 FROM -120 TO 140 WITH 1041
    ...
    ? Found a generic form of the rate equation for alpha, using expression: v < -10 ? (2 / 37.95) * ( exp ( ((v + 50 ) / 11) - (( v + 53.5) / 27) ) ) : 2 * (exp ( ( (-1 * v) - 53.5 ) / 27 ))
    ...
    ? Found a generic form of the rate equation for beta, using expression: v < -10 ? 2 * (exp ( ( (-1 * v) - 53.5 ) / 27 )) - alpha : 0.0
